...
echo "`n"
echo "OUTPUT"
az group create --name demoRGam --location eastus
Write-Output "--------------------------------------------------------------------"
echo "`n"
...
echo "`n"
echo "OUTPUT"
az acr create --resource-group demoRGam --name DemoAcram --sku Basic
Write-Output "--------------------------------------------------------------------"
echo "`n"
...
echo "`n"
echo "OUTPUT"
az ad sp create-for-rbac --skip-assignment -n demoClusterAM
Write-Output "--------------------------------------------------------------------"
echo "`n"